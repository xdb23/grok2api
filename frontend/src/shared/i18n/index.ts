  ...
  "zh-CN": {
    translation: {
      ...
      accountConversion: {
        ...
        all: "重新转换全部",
        start: "开始转换",
        forceLabel: "强制转换已阻断账号",
        forceDescription: "默认跳过曾因 invalid_grant 标记为无法转 Build 的 Web 账号；勾选后才会重试这批。Console 转换不受影响。",
      },
      webConsoleSync: {
        action: "转换为 Console",
      ...
      console: {
        ...
        availabilityHint: "本地开关 · 上游限流时进入冷却（非固定次数）",
      },
      accountCredential: {
        label: "凭据续期",
      ...
      statusReauthRequired: "失效",
        ...
        associationAllUnlinked: "全部未关联", associationBuildConvertBlocked: "Build 转换已阻断", associationBuildConvertAllowed: "Build 可转换", statusAbnormal: "异常", statusAbnormalDetail: "异常细分", requestStats: "请求", requestStatsTodayShort: "今 {{ok}}/{{fail}}", requestStatsTooltip: "累计成功 {{totalOk}} · 失败 {{totalFail}}；今日成功 {{todayOk}} · 失败 {{todayFail}}", buildConvertBlocked: "禁转 Build", buildConvertBlockedTooltip: "因 {{reason}} 无法自动转 Build（{{time}}），Console 仍可转换",
        buildRouteMode: {
          label: "上游地址",
          auto: "自动",
          build: "Build",
      ...
      audits: {
        ...
        upstreamModel: "上游模型",
        accountStats: "账号战绩",
        accountStatsShort: "成 {{success}} · 败 {{failed}} · 共 {{total}}",
        accountStatsAsOf: "截至本请求 成 {{success}} · 败 {{failed}} · 共 {{total}}",
        accountStatsAsOfHint: "截至本请求",
        accountStatsAsOfNote: "数字为该账号在本条请求（含本条）之前的累计成功/失败，同行不同请求会递增变化。",
        accountStatsDetail: "共 {{total}} 次 · 成功 {{success}} · 失败 {{failed}}",
        accountRequests: "历史请求",
        accountSuccess: "历史成功",
        accountFailure: "历史失败",
        createdAt: "时间",
        stream: "流式",
        ...
        statusIssues: "仅异常（含软失败）",
        clickForDiagnostics: "点击查看安全诊断详情",
        errorCode: "错误码",
        softFailureHint: "该请求没有分步 attempt 记录（常见于流中断/无可用账号）。上方为审计层错误摘要。",
      ...
      settings: {
        ...
        routing: { title: "路由策略", stickyTTL: "会话粘性时长", stickyTTLHelp: "同一会话优先复用已选账号的有效时长；到期后重新参与调度。", cooldownBase: "基础冷却时间", cooldownBaseHelp: "账号发生可恢复故障后首次进入冷却的时长。", cooldownMax: "最大冷却时间", cooldownMaxHelp: "连续故障触发指数退避时允许达到的最长冷却时间。", capacityWait: "账号满载等待", capacityWaitHelp: "全部候选账号并发已满时，切换或失败前等待容量释放的时间。", maxAttempts: "最大尝试次数", maxAttemptsHelp: "单次请求在可用账号之间切换并重试的最大次数；填 0 表示不限制（仍有运行时安全上限）。", preferFreeBuild: "Grok Build Free 账号优先", preferFreeBuildHelp: "启用后优先选择已确认可用的 Free 账号，其他路由条件保持不变。" }, spendingLimit: { title: "Build 402 换出口", maxEgressRotations: "同号换代理次数", maxEgressRotationsHelp: "Build 返回 spending-limit 402 时，同一账号额外释放 Resin 粘性出口并重试的次数（1–10，默认 3）。耗尽后进入软冷却。", softCooldown: "402 软冷却时长", softCooldownHelp: "换出口次数用尽后，将该账号短暂移出调度的时长（1 分钟–72 小时，默认 1 小时）。不同于额度用尽，仅软停用。" },
  ...
  en: {
    translation: {
      ...
      accountConversion: {
        ...
        forceLabel: "Force convert blocked accounts",
        forceDescription: "By default, Web accounts blocked by invalid_grant are skipped for Build conversion. Enable this to retry them. Console conversion is unaffected.",
      },
      webConsoleSync: {
      ...
      console: {
        ...
        availabilityHint: "Local availability flag · cools on upstream rate limit (not a fixed budget)",
      },
      accountCredential: {
      ...
      audits: {
        ...
        ttftShort: "TTFT",
        ttftUnavailable: "TTFT n/a",
        tps: "Tokens / sec",
        firstHeaders: "First headers",
        selection: "Selection",
        credential: "Credential",
        upstreamWait: "Upstream wait",
        upstreamAttempts: "Upstream attempts",
        failedAttempts: "Failed attempts",
        upstreamModel: "Upstream model",
        accountStats: "Account stats",
        accountStatsShort: "ok {{success}} · fail {{failed}} · n {{total}}",
        accountStatsAsOf: "as of this req · ok {{success}} · fail {{failed}} · n {{total}}",
        accountStatsAsOfHint: "As of this request",
        accountStatsAsOfNote: "Running totals for this account up to and including this row; same account rows increase over time.",
        accountStatsDetail: "{{total}} total · {{success}} ok · {{failed}} failed",
        accountRequests: "Lifetime requests",
        accountSuccess: "Lifetime successes",
        accountFailure: "Lifetime failures",
        createdAt: "Time",
        stream: "Streaming",
        ...
        statusIssues: "Issues only (incl. soft failures)",
        clickForDiagnostics: "Click for safe diagnostics",
        errorCode: "Error code",
        softFailureHint: "No per-attempt diagnostics were stored (common for stream interrupts / no available account). Summary above is from the audit record.",
